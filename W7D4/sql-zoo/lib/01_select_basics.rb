...
# SELECT name, gdp/population AS "per capita gdp" FROM countries WHERE area > 5*10^6;
...
# SELECT name, (area / 1000) AS "area in Mm" FROM countries WHERE area BETWEEN 200000 AND 250000;
